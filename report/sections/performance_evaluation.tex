...
\subsubsection{Small to Medium Matrices (\texorpdfstring{$N=2048, 4096$}{N=2048, 4096})}
...
\subsubsection{Large Matrices (\texorpdfstring{$N=16,384$ -- $65,536$}{N=16,384 -- 65,536})}
...
\begin{itemize}
    ...
    Using a hybrid approach (e.g., 16 MPI processes $\times$ 4 OpenMP threads)
    ...
    $\log_2(P_{col})$, reducing the number of MPI ranks by a factor of 4
