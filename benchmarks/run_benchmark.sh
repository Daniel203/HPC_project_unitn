...
CONFIGURATIONS=(
    "512:1:1:1:scatter:excl"
    "1024:2:1:2:scatter:excl"
...
for CONFIG in "${CONFIGURATIONS[@]}"; do
    ...
    PBS_SCRIPT="pbs_scripts/${SAFE_JOB_NAME}.pbs"
...
#PBS -q ${QUEUE}
#PBS -o execution_output/${RANDOM_ID}_${SAFE_JOB_NAME}.o
#PBS -e execution_output/${RANDOM_ID}_${SAFE_JOB_NAME}.e
...
mpirun.actual -n ${N_PROCS} ./main_mpi ${N_MATRIX}
...
echo "  tail -f execution_output/*.out"
echo ""
echo "Results will be saved in: benchmark_results.csv"
echo "=========================================="
